...
namespace Template.Toolkit.CreationPipeline
{
    ...
    public static class AssetPaths
    {
        ...
        {
            return Path.Combine(repositoryRoot, "_Tasks", requirementIdentifier, "资产请求");
        }
        ...
        /// <summary>某资产的变体目录：_Tasks/&lt;需求id&gt;/30-产物/&lt;资产id&gt;/变体。</summary>
        /// <param name="repositoryRoot">仓库根目录。</param>
        /// <param name="requirementIdentifier">需求 id，如「REQ-0042」。</param>
        /// <param name="assetIdentifier">资产 id，如「ASSET-0042-01」。</param>
        public static string VariantDirectory(string repositoryRoot, string requirementIdentifier, string assetIdentifier)
        {
            return Path.Combine(repositoryRoot, "_Tasks", requirementIdentifier, "30-产物", assetIdentifier, "变体");
        }
        ...
        {
            return Path.Combine(VariantDirectory(repositoryRoot, requirementIdentifier, assetIdentifier), "人工");
        }

        /// <summary>某变体文件的溯源边车文件：变体目录下的 &lt;变体文件名&gt;.溯源.json。</summary>
        /// <param name="repositoryRoot">仓库根目录。</param>
        /// <param name="requirementIdentifier">需求 id，如「REQ-0042」。</param>
        /// <param name="assetIdentifier">资产 id，如「ASSET-0042-01」。</param>
        ...
        {
            return Path.Combine(VariantDirectory(repositoryRoot, requirementIdentifier, assetIdentifier), $"{variantFileName}.溯源.json");
        }

        /// <summary>不合格变体的弃置目录：30-产物/&lt;资产id&gt;/弃。</summary>
        /// <param name="repositoryRoot">仓库根目录。</param>
        /// <param name="requirementIdentifier">需求 id，如「REQ-0042」。</param>
        /// <param name="assetIdentifier">资产 id，如「ASSET-0042-01」。</param>
        public static string RejectedDirectory(string repositoryRoot, string requirementIdentifier, string assetIdentifier)
        {
            return Path.Combine(repositoryRoot, "_Tasks", requirementIdentifier, "30-产物", assetIdentifier, "弃");
        }
        ...
        {
            return Path.Combine(repositoryRoot, "_Tasks", requirementIdentifier, "预览", $"{assetIdentifier}.png");
        }
    }
}
