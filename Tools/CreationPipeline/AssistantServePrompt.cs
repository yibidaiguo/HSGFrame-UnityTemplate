...
namespace Template.Toolkit.CreationPipeline
{
    ...
    public sealed class AssistantServePrompt
    {
        ...
        public const string OutputContract =
            ...
            + "10. **画布比例要跟画面对上**。「宽/高」填 0 表示用资产规格的缺省（界面底图缺省是\n"
            + "    1080×1920 竖屏，按手机来的）。人要的是 **PC 端 / 横屏**界面时，必须填成横的\n"
            + "    （比如 1920×1080）——在竖画布上画横向布局，出来的东西看着就像被压扁了。\n"
            + "    描述里也别再写「16:9 分辨率」这类话：比例是「宽/高」说了算的，写进描述只会打架。\n"
