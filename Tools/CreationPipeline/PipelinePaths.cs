...
namespace Template.Toolkit.CreationPipeline
{
    ...
    public static class PipelinePaths
    {
        ...
        {
            return Path.Combine(repositoryRoot, "_Tasks", requirementIdentifier, "变更");
        }
        ...
        {
            return Path.Combine(repositoryRoot, "_Generated", "拒收");
        }
        ...
        {
            return Path.Combine(repositoryRoot, "_Tasks", requirementIdentifier, "变更", "累积.json");
        }
        ...
        {
            return Path.Combine(repositoryRoot, "_Generated", "出站");
        }
