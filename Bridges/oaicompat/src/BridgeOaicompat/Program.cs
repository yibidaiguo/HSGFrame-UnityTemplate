...
namespace Template.Bridges.Oaicompat
{
    ...
    /// 与 BridgeBlender 同构，只是把「起子进程」换成「发 HTTP」。
    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("BridgeOaicompat 内部错误：" + exception.Message);
        ...
        private static void WriteResponse(BridgeResponse response)
        {
            ...
            Console.Error.WriteLine("BridgeOaicompat 处理完成，成功=" + response.Succeeded);
        }
    }
}
